...
$qry = $conn->query("SELECT *,concat(lastname,', ',firstname,' ',middlename) as name, concat(address,', ',street,', ',phone,', ',city,', ',state,', ',zip_code) as caddress FROM persons where id= ".$_GET['id']);
