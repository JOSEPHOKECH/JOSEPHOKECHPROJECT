					...
					<div class="card-body">
						<table class="table table-condensed table-hover">
							...
							<tbody>
								<?php 
								$i = 1;
								$types = $conn->query("SELECT *,concat(lastname,', ',firstname,' ',middlename) as name, concat(address,', ',street,', ',phone,', ',city,', ',state,', ',zip_code) as caddress FROM persons order by name asc");
